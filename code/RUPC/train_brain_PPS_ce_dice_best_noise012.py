...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            tmp1 = outputs1[:args.labeled_bs]
            tmp2 = label_batch[:args.labeled_bs].long()
            tmp3 = outputs_soft1[:args.labeled_bs]
            tmp4 = label_batch[:args.labeled_bs]
            ...
            loss3 = 0.5 * (ce_loss(outputs3[:args.labeled_bs],
                                   label_batch[:][:args.labeled_bs].long()) + dice_loss(
            ...
            # pseudo_supervision2 = ce_loss(outputs2[args.labeled_bs:], pseudo_outputs3)
            # pseudo_supervision3 = ce_loss(outputs3[args.labeled_bs:], pseudo_outputs1)

            pseudo_supervision1 = dice_loss(outputs1[args.labeled_bs:], pseudo_outputs2.unsqueeze(1))
            pseudo_supervision2 = dice_loss(outputs2[args.labeled_bs:], pseudo_outputs3.unsqueeze(1))
            pseudo_supervision3 = dice_loss(outputs3[args.labeled_bs:], pseudo_outputs1.unsqueeze(1))
