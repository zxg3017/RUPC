...
from dataloaders.la_heart import LAHeart, Liver_data, RandomCrop, CenterCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler
from utils1.util import compute_sdf
from test_util import test_all_case

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default='/mnt/ai2019/jing/data/2018LA_Seg_Training/', help='Name of Experiment')
parser.add_argument('--exp', type=str,  default='LA_8labels', help='model_name')
...
snapshot_path = "/mnt/ai2019/zxg_FZU/weakly_supervised/SASSnet/model_result/" + args.exp + "/"
...
def test():
    ...
    snapshot_path = '/mnt/ai2019/zxg_FZU/weakly_supervised/SASSnet/model_result/LA_8labels/'
