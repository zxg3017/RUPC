...
from val_3D import val_all_case_sdf
from networks.net_factory_3d import net_factory_3d

from networks.VNet_SDF import VNet_SDF
...
from utils_.util import compute_sdf

parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='../data/BraTS2019', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='DTC_8_brain', help='model_name')
parser.add_argument('--model', type=str,
                    default='vnet_sdf', help='model_name')
...
parser.add_argument('--labeled_num', type=int,  default=16, help='random seed')
...
if __name__ == "__main__":
    ...
    def create_model(ema=False):
        ...
        net = VNet_SDF(n_channels=1, n_classes=num_classes-1,
    ...
    labelnum = args.labeled_num    # default 16
    labeled_idxs = list(range(labelnum))
    unlabeled_idxs = list(range(labelnum, 250))
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # calculate the loss
            with torch.no_grad():
                tmp = label_batch[:].cpu().numpy()
                tmp2 = outputs[:labeled_bs, 0, ...].shape
