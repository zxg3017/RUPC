...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss1 = 0.5 * (losses.dice_loss(outputs1[:args.labeled_bs],
                                     label_batch[:][:args.labeled_bs]) + losses.dice_loss(
                outputs_soft1[:args.labeled_bs], label_batch[:args.labeled_bs]))
            loss2 = 0.5 * (losses.dice_loss(outputs2[:args.labeled_bs],
                                     label_batch[:][:args.labeled_bs].unsqueeze(1)) + losses.dice_loss(
...
def test():
    # snapshot_path = '/mnt/ai2019/zxg_FZU/semi-supervised/model_heart/LA/ce_loss_8labels_beta_0.3/'
    num_classes = 2
