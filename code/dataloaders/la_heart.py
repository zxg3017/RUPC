...
class LAHeart(Dataset):
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        train_path = '/mnt/ai2021/zxg/dataset/2018LA_Seg_Training/' + 'train_list.txt'
        test_path = '/mnt/ai2021/zxg/dataset/2018LA_Seg_Training/' + 'val_list.txt'
    ...
    def __getitem__(self, idx):
        ...
        h5f = h5py.File('/mnt/ai2021/zxg/dataset/2018LA_Seg_Training' + "/" + image_name + "/mri_norm2.h5", 'r')
        image = h5f['image'][:]
        label = h5f['label'][:]
        # print(label.shape)
